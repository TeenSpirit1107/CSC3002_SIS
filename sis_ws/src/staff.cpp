...
void insert_at_tail2(node1 *head, string filename) {
...
void print_list2_rev2(node1 *head) {
    if (head == nullptr) return;
    node1 *p = head->prv;
    bool flag = true;
...
void list_delete2(node1 *&head, node1 *p) {
